...
def cifrar_cesar(byte):
    return (byte + clave_cesar) % 256
...
for i in range(0, PIXELS, BITS_PER_PKT):
    ...
    packed_bytes.append(cifrar_cesar(byte))
...
print(f"[Python] Cifrado César activo (clave = {clave_cesar})")
